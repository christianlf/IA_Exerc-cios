...
class Vertice:
    ...
    def __init__(self, rotulo, distancia_objetivo):
        self.rotulo = rotulo  # Nome do vértice
        self.visitado = False  # Flag para verificar se o vértice foi visitado
        self.distancia_objetivo = distancia_objetivo  # Distância estimada até o objetivo
        self.adjacentes = []  # Lista de vértices adjacentes
...
# Classe que representa um adjacente com seu vértice e custo
class Adjacente:
    def __init__(self, vertice, custo):
        self.vertice = vertice  # Vértice adjacente
        self.custo = custo  # Custo para chegar ao vértice adjacente
...
# Inicializa o grafo com os vértices e suas conexões
grafo = Grafo()

# Classe que representa um vetor ordenado
class VetorOrdenado:
...
# Classe que representa a busca gulosa
class Gulosa:
    def __init__(self, objetivo):
        self.objetivo = objetivo  # Vértice objetivo
        self.encontrado = False  # Flag para indicar se o objetivo foi encontrado

    # Método para buscar o objetivo a partir de um vértice atual
